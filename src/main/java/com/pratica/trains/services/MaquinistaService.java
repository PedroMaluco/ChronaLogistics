...
public class MaquinistaService {
	...
	public MaquinistaDTO findById(Long id) {
		Maquinista maqui = repository.findById(id).orElseThrow(()->new ObjectNotFoundException("Maquinista não encontrado"));
	...
	public List<MaquinistaDTO> findAll() {
		List<Maquinista> maqui = repository.findAll();
