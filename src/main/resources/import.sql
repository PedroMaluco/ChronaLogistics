INSERT INTO "tb_maquinista"(nome, idade, soldo, email, senha, role) VALUES ('Krauspenhar', 26, 2750.00, 'kraus@outlook.com', '$2a$10$UDL4BSdgk8lHMxXTqu.Kq.LCZGvfP0ZIQ4nuhkmDAYJlXJ5eqwsV.', 'ENGENHEIRO_CHEFE');
INSERT INTO "tb_maquinista"(nome, idade, soldo, email, senha, role) VALUES ('Da Silva', 36, 4550.00, 'silva@yahoo.com', '$2a$10$UDL4BSdgk8lHMxXTqu.Kq.LCZGvfP0ZIQ4nuhkmDAYJlXJ5eqwsV.', 'ENGENHEIRO_CHEFE');
INSERT INTO "tb_maquinista"(nome, idade, soldo, email, senha, role) VALUES ('Severo', 22, 2500.00, 'saveiro@outlook.com', '$2a$10$UDL4BSdgk8lHMxXTqu.Kq.LCZGvfP0ZIQ4nuhkmDAYJlXJ5eqwsV.', 'ENGENHEIRO_USUARIO');
INSERT INTO "tb_maquinista"(nome, idade, soldo, email, senha, role) VALUES ('Padilha', 25, 2850.00, 'padilha@gmail.com', '$2a$10$UDL4BSdgk8lHMxXTqu.Kq.LCZGvfP0ZIQ4nuhkmDAYJlXJ5eqwsV.', 'ENGENHEIRO_USUARIO');
